...
<head>
    ...
    <title>App Corporate | Front - Multipurpose Responsive Template</title>
...
<body id="homeSection" class="position-relative">
                    ...
                    <ul id="navbarNavDropdownNav" class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="btn btn-primary btn-transition"
                                ...
                                target="_blank">Get your <strong>Free 15-Day Trial</strong></a>
                        </li>
                        <!-- End Button -->
                    </ul>
                </div>
    ...
    <main id="content" role="main">
        <!-- Hero -->
        <div class="position-relative min-vh-100 content-space-t-3 content-space-t-md-4 content-space-t-lg-4 bg-dark"
            ...
            <div class="container">
                <div class="row justify-content-lg-between align-items-lg-center">
                    <div class="col-md-10 col-lg-5 mb-9 mb-lg-0">
                        <!-- Info -->
                        <h1 class="text-white">EFFICIENT. EASY TO USE.
                            JUST THE CRM YOUR SMALL BUSINESS NEEDS!</h1>
                        <p class="text-white-70">Axonaut is the all-in-one tool that delivers the unbeatable
                            combination of power, efficiency and simplicity, all at a price that won’t break the bank.
                        </p>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card card-lg">
                            <div class="card-body">
                                <div class="mb-4">
                                    <h3 class="card-title">Start your free 30-days trial</h3>
                                </div>
                                ...
                                <form>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label visually-hidden"
                                                    for="hireUsFormFirstName">First name</label>
                                    ...
                                    <div class="row gx-3">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label visually-hidden"
                                                    for="hireUsFormWorkEmail">Email address</label>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label visually-hidden"
                                                    for="hireUsFormCompanyName">Company name <span
                                    ...
                                    <div class="form-check small mb-4">
                                        ...
                                        <label class="form-check-label" for="signupFormPrivacyCheck"> Yes, I'd like to
                                            receive occasional marketing emails. I have the right to opt out
                                            at any time. <a class="link" href="page-privacy.html">View privacy
                                                policy.</a></label>
                                    </div>
                                    <!-- End Check -->

                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-primary btn-lg">Start your free 30-days
                                            trial</button>
                                    </div>
                                </form>
                                <!-- End Form -->
        ...
        <div id="aboutSection" class="container content-space-t-2 content-space-t-lg-3">
            ...
            <div class="w-lg-75 text-center mx-auto mb-5 mb-sm-9">
                <h2 class="h1">Running a small business is hard enough.</h2>
                <p>You deserve a CRM that makes it easier.</p>
            </div>
            <!-- End Heading -->
            ...
            <div class="row">
                <div class="col-md-4 mb-7">
                    ...
                    <div class="text-center px-lg-3">
                        ...
                        <h3>EASY</h3>
                        <p>Say goodbye to complex CRMs and ERPs forever.</p>
                    </div>
                    <!-- End Icon Blocks -->
                </div>
                <!-- End Col -->
                ...
                <div class="col-md-4 mb-7">
                    ...
                    <div class="text-center px-lg-3">
                        ...
                        <h3>EFFICIENT</h3>
                        <p>We take care of all the time-consuming tasks, so you can focus on your business.</p>
                    </div>
                    <!-- End Icon Blocks -->
                </div>
                <!-- End Col -->
        ...
        <div class="container">
            ...
            <div class="w-md-60 w-lg-50 text-center mx-auto mb-7">
                <p><span class="text-dark fw-semi-bold">It is fast and easy.</span> Create and manage your business</p>
            </div>
            <!-- End Heading -->
            ...
            <div class="devices">
                <!-- Mobile Device -->
                <iframe width="100%" height="500" src="https://www.youtube.com/embed/NOcR8bkYpzM"
            ...
            <div class="text-center mx-auto" style="max-width: 20rem;">
                <p class="small"> <strong>Need help ?</strong> Discover the tool with us</p>
                <div class="">
                    <a class="btn btn-primary btn-transition me-2" href="page-login-simple.html">
                        Book a Demo <i class="bi-chevron-right small ms-1"></i>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container content-space-2 content-space-lg-3">
            <div class="row justify-content-lg-between align-items-lg-center">
                <div class="col-lg-5 mb-9 mb-lg-0">
                    <div class="mb-3">
                        <h2 class="h1">Axonaut is your business’s right hand.</h2>
                        <h1 class="display-3 text-success">CRM <i class="bi bi-check2-square me-1"></i></h1>
                    </div>

                    <p>Manage all your contacts in one convenient place.
                        Make customer relationships easier and more productive.
                        Fast. Easy. Awesome!</p>
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <p>Integrate your emails and calendar.</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <p>Manage your sales cycles.</p>
                            </div>
                        </div>
                    </div>

                    <div class="mt-4">
                        <a class="btn btn-primary btn-transition px-5" href="#">Get Started Today</a>
                    </div>
                </div>
                <!-- End Col -->
                ...
                <div class="col-lg-6 col-xl-5">
                    ...
                    <div class="position-relative mx-auto" style="max-width: 28rem; min-height: 30rem;">
                        <figure class="position-absolute top-0 end-0 zi-2 me-10 aos-init aos-animate"
                            data-aos="fade-up">
                            ...
                            c123.6,0,223.7,100.2,223.7,223.7l0,0C448.7,348.6,348.5,448.7,225,448.7z"></path>
                                    ...
                                    <g clip-path="url(#circleImgID1)">
                                        <image width="450" height="450" xlink:href="./assets/img/450x450/img1.jpg">
                                        </image>
                                    </g>
                                </g>
                            </svg>
                        ...
                        <figure class="position-absolute top-0 start-0 aos-init aos-animate" data-aos="fade-up"
                            data-aos-delay="300">
                        ...
                        <figure class="d-none d-sm-block position-absolute top-0 start-0 mt-10 aos-init aos-animate"
                        ...
                        <figure class="position-absolute top-0 end-0 aos-init aos-animate"
                            style="margin-top: 11rem; margin-right: 13rem;" data-aos="fade-up" data-aos-delay="250">
                        ...
                        <figure class="position-absolute top-0 end-0 me-3 aos-init aos-animate"
                            style="margin-top: 8rem;" data-aos="fade-up" data-aos-delay="350">
                        ...
                        <figure class="position-absolute bottom-0 end-0 aos-init aos-animate" data-aos="fade-up"
                            data-aos-delay="400">
        ...
        <div class="container content-space-2 content-space-lg-3">
            <div class="row justify-content-lg-between align-items-lg-center">
                ...
                <div class="col-lg-5 mb-9 mb-lg-0">
                    <div class="mb-3">
                        <h1 class="display-3 text-success">QUOTES & INVOICES <i class="bi bi-check2-square me-1"></i>
                        </h1>
                    </div>

                    <p>Generate branded quotes and invoices. Convert quotes to invoices with one click.</p>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <p>Stripe and Gocardless enabled for online payment.</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <p>Manage deposits, invoicing status and balances, including for recurring invoices.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container content-space-2 content-space-lg-3">
            <div class="row justify-content-lg-between align-items-lg-center">
                <div class="col-lg-5 mb-9 mb-lg-0">
                    <div class="mb-3">
                        <h1 class="display-3 text-success">FINANCIAL OVERVIEW & STATISTICS <i
                                class="bi bi-check2-square me-1"></i></h1>
                    </div>

                    <p>Manage revenues, expenses and cash flow.
                        Monitor bank transactions and account balances.
                        Get detailed statistics.</p>
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <p>Link to your bank account for accurate reconciliation.</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                            <div class="flex-shrink-0">
                            ...
                            <div class="flex-grow-1 ms-2">
                                <p>View and digitize invoices and expense receipts (OCR).</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-lg-between align-items-lg-center">
                    ...
                    <div class="position-relative mx-auto" style="max-width: 20rem;">
                        ...
                        <figure class="device-mobile mx-auto">
                            <div class="device-mobile-frame">
                                <img class="device-mobile-img" src="./assets/img/407x867/img5.jpg"
                ...
                <div class="col-lg-5">
                    ...
                    <div class="mb-5">
                        ...
                        <p>Automate accounting tasks. Customize your export process and formats. Manage company-specific
                            accounting codes.</p>
                        <div class="col-12">
                            <div class="d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h5>Automate sales, expenses, taxes.</h5>
                                </div>
                            </div>
                            <div class="d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h5>Export custom file formats for your accountant.</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="position-relative">
                    <div class="bg-light text-center rounded-2 p-4 p-md-7">
                        <div class="d-flex justify-content-center align-items-center">
                            <h2 class="display-2 text-primary"><i class="bi bi-check2-square"></i></h2>
                            <h2 class="ms-4">WAIT, THERE'S MORE!</h2>
                        </div>
                        <div class="row text-start">
                            <div class="col-md-6">
                                <h2 class="my-5">MARKETING</h2>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Create and manage email and text message marketing campaigns.</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="200">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Group and segment mailing lists with multi-criteria for a more targeted
                                            approach.</p>
                                    </div>
                                </div>
                                <h2 class="my-5">HUMAN RESOURCES</h2>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="200">
                                    <div class="flex-shrink-0">
                                        <span class="svg-icon text-primary">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Manage your team and associated costs with the Staff Registry.</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="200">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Manage vacations and days off with the visual planner.</p>
                                    </div>
                                </div>
                                <h2 class="my-5">TICKETING</h2>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="200">
                                    <div class="flex-shrink-0">
                                        <span class="svg-icon text-primary">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Manage after-sales service simply and collaboratively.</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="200">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Create, share and comment on tickets for superior customer service.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Create projects and plan tasks for your team.</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="200">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Track budgets, time spent and project profitability.</p>
                                    </div>
                                </div>
                                <h2 class="my-5">STOCK MANAGEMENT</h2>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="200">
                                    <div class="flex-shrink-0">
                                        <span class="svg-icon text-primary">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Track your inventory, including entries and withdrawals.</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="200">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Calculate your stock value using the average cost method.</p>
                                    </div>
                                </div>
                                <h2 class="my-5">CUSTOMER PORTAL</h2>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="200">
                                    <div class="flex-shrink-0">
                                        <span class="svg-icon text-primary">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Provide your customers with a secure, dedicated space.</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="200">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Get notified when a customer views a quote.</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center aos-init aos-animate" data-aos="fade-up"
                                    data-aos-delay="200">
                                    ...
                                    <div class="flex-grow-1 ms-2">
                                        <p>Get statistics on time spent per document viewed, and more.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container content-space-2">
              <div class="row justify-content-lg-between align-items-lg-center">
                <div class="col-md mb-5 mb-md-0">
                  <h2 class="text-white mb-0">Create better experiences in your business</h2>
                </div>
                <!-- End Col -->
      
                <div class="col-md-auto">
                  <div class="d-grid d-sm-flex gap-3">
                    <a class="btn btn-light btn-transition" href="#">Contact sales</a>
...
<!-- Mirrored from htmlstream.com/front/landing-onepage-corporate.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Jan 2022 18:39:09 GMT -->
